    ...
    return (
        ...
        <div className='Header'>
            ...
            <div className='HeaderBox'>
                ...
                <a className='HeaderItem' href='#'>فرصت شغلی</a>
                <a className='HeaderItem' href='#'>بلاگ</a>
                <a className='HeaderItem' href='#'>باشگاه رانندگان</a>
                <a className='HeaderItem' href='#'>ثبت نام راننده اسنپ</a>
                <a className='HeaderItem' href='#'>پنل سازمانی</a>
                <a className='HeaderItem' href='#'>درباره ما</a>
                <a className='HeaderItem' href='#'>تماس با ما</a>
